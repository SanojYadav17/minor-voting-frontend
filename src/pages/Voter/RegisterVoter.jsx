...
const RegisterVoter = () => {
  ...
  const handleVoterRegistration = async (e) => {
    try {
      ...
      const imageUploadStatus = await uploadVoterImage(file, email);
      ...
      if (imageUploadStatus === true) {
        ...
        // Update to success with custom component
        toast.success((t) => (
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              <div style={{ fontWeight: '700', fontSize: '16px' }}>Registered!</div>
              <div style={{ fontSize: '12px', opacity: 0.8 }}>Welcome to voting</div>
            </div>
          </div>
        ), {
          id: toastId,
      ...
      // Compact error toasts with gradient
        ...
        toast((t) => (
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', opacity: 0.85 }}>One wallet, one vote</div>
            </div>
          </div>
        ), {
          duration: 3000,
      ...
      } else if (error.message.includes("Age must be 18")) {
        toast((t) => (
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{ fontSize: '28px' }}>🔞</span>
            <div>
              <div style={{ fontWeight: '700', fontSize: '15px' }}>Age Restriction</div>
              <div style={{ fontSize: '11px', opacity: 0.85 }}>Must be 18+</div>
            </div>
          </div>
        ), {
          duration: 3000,
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white p-4 sm:p-8 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-block mb-4">
            <div className="bg-blue-500/10 backdrop-blur-lg px-6 py-2 rounded-full border border-blue-500/30">
              <span className="text-blue-300 text-sm font-bold">Registration Portal</span>
            </div>
          </div>
          ...
          <p className="text-gray-400 font-bold">Fill in your details to participate in the election</p>
          ...
          <form onSubmit={handleVoterRegistration} className="space-y-6">
            ...
            <div className="group">
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-gray-600 bg-gray-900/70 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 placeholder-gray-500"
                required
              />
            </div>
            ...
            <div className="group">
              ...
              <select
                ref={genderRef}
                className="w-full px-4 py-3 border-2 border-gray-600 bg-gray-900/70 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 cursor-pointer"
                required
              >
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <label 
                  htmlFor="file-upload" 
                  className="flex items-center justify-center w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl cursor-pointer transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
            ...
            {/* Info Box */}
            <div className="bg-blue-900/30 border border-blue-500/30 rounded-xl px-6 py-4 sm:px-8 sm:py-4 w-full sm:w-[95%] lg:w-[90%] mx-auto">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-blue-300 text-base font-bold mb-2">Important Information</p>
                  <ul className="text-white text-sm space-y-2">
                    <li>• You must be 18 years or older to register</li>
                    <li>• Photo should be clear and recent</li>
                    <li>• Registration is permanent on the blockchain</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300 text-sm font-bold">
            Already registered? 
            <a href="/voter-list" className="text-blue-300 hover:text-blue-200 ml-1 font-bold underline">
              View Voter List
            </a>
          </p>
        </div>
